 ...
 */
@BeanDefinition
public final class Direct implements ImmutableBean, Serializable {
    ...
    ///CLOVER:OFF
    /**
     * The meta-bean for {@code Direct}.
     * @return the meta-bean, not null
     */
    public static Direct.Meta meta() {
        return Direct.Meta.INSTANCE;
    }

    static {
        JodaBeanUtils.registerMetaBean(Direct.Meta.INSTANCE);
    }
     ...
     */
    public static Direct.Builder builder() {
        return new Direct.Builder();
    }
    ...
    public static final class Meta extends DirectMetaBean {
        ...
        private final MetaProperty<ImmutableList<String>> list = DirectMetaProperty.ofImmutable(
                this, "list", Direct.class, (Class) ImmutableList.class);
        /**
         * The meta-property for the {@code currency} property.
         */
        private final MetaProperty<Currency> currency = DirectMetaProperty.ofImmutable(
                this, "currency", Direct.class, Currency.class);
        /**
         * The meta-properties.
         */
        ...
        @Override
        public Class<? extends Direct> beanType() {
            return Direct.class;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<Boolean> flag() {
            return flag;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<String> town() {
            return town;
        }
         ...
         * @return the meta-property, not null
         */
        public MetaProperty<ImmutableList<String>> list() {
            return list;
        }
        ...
        protected Object propertyGet(Bean bean, String propertyName, boolean quiet) {
            switch (propertyName.hashCode()) {
                case -1034364087:  // number
                    return ((Direct) bean).getNumber();
                case 3145580:  // flag
                    return ((Direct) bean).isFlag();
                case -891990013:  // street
                    return ((Direct) bean).street;
                case 3566226:  // town
                    return ((Direct) bean).town;
                case 3053931:  // city
                    return ((Direct) bean).getCity();
                case 106164915:  // owner
                    return ((Direct) bean).getOwner();
                case 3322014:  // list
                    return ((Direct) bean).getList();
                case 575402001:  // currency
                    return ((Direct) bean).currency;
            }
    ...
    //-----------------------------------------------------------------------
    /**
     * The bean-builder for {@code Direct}.
     */
    public static final class Builder extends DirectFieldsBeanBuilder<Direct> {
         ...
         */
        private Builder(Direct beanToCopy) {
